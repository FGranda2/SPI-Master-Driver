...
REM
REM Generated by Vivado on Mon May 09 19:15:36 -0400 2022
...
echo "xvlog --incr --relax -L uvm -prj spi_drv_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj spi_drv_TB_vlog.prj -log xvlog.log
